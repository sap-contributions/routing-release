...
require (
	...
	code.cloudfoundry.org/routing-api v0.4.0
	...
	github.com/cloudfoundry/sonde-go v0.0.0-20260622134720-d7b012c5b9c4
...
require (
	...
	code.cloudfoundry.org/eventhub v0.79.0 // indirect
